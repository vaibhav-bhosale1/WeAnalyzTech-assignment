...
const TechnicalMyTicket: React.FC = () => {
  const [searchTerm, setSearchTerm] = useState('');
  const [showModal, setShowModal] = useState(false);
  const [modalType, setModalType] = useState<'details' | 'close'>('details');
  ...
  const openModal = (type: 'details' | 'close') => {
    setModalType(type);
    setShowModal(true);
  };
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-gray-600">Manage your assigned technical support tickets.</p>
      </div>
          ...
          <div className="bg-white rounded-xl p-6 w-full max-w-md mx-4">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-lg font-semibold text-gray-900">
                {modalType === 'details' ? 'Ticket Details' : 'My Ticket - Close Ticket'}
              </h3>
              <button
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-2 gap-4 text-sm">
                  ...
                  <div className="col-span-2">
                    ...
                    <p className="font-medium">Technical issue with system access</p>
                  </div>
                  <div>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <select className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent">
                    ...
                    <option>Technical Support 1</option>
                    <option>Technical Support 2</option>
                    <option>Technical Support 3</option>
                  </select>
                </div>
