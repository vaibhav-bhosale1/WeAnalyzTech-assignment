...
const TechnicalProfileSettings: React.FC = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    newPassword: '',
    confirmPassword: '',
    email: 'technical@helpdesk.com',
    realName: 'Technical Specialist',
    accessLevel: 'Technician',
    reportAccessLevel: 'Standard Access',
  });
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    console.log('Technical profile updated:', formData);
...
export default TechnicalProfileSettings;